...
class JAXON_RED_HrpsysConfigurator(ChoreonoidHrpsysConfiguratorOrg):
    ...
    def startABSTIMP (self):
        ...
        ### set gravity 1.6249
        gg_param = self.abc_svc.getGaitGeneratorParam()[1]
        gg_param.gravitational_acceleration = 1.6249
        self.abc_svc.setGaitGeneratorParam(gg_param)
        st_param = self.st_svc.getParameter()
        st_param.eefm_gravitational_acceleration = 1.6249
        self.st_svc.setParameter(st_param)
        ###
