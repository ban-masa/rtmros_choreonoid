...
class HRP2JSKNT_HrpsysConfigurator(ChoreonoidJSKHRP2HrpsysConfiguratorOrg):
    def getRTCList (self):
        ...
        return [
            ...
            # ['tc', "TorqueController"],                                                                                                                           # ['te', "ThermoEstimator"],                                                                                                                           # ['tl', "ThermoLimiter"],
    ...
    def startABSTIMP (self):
        ...
        time.sleep(4)# transition hot fix
